import { resolveInputValue, type WorkflowFile } from "@cozy/runtime"
...
export interface EmitWorkflowOptions {
   ...
   * project root, where cozy.config and nodes/ live.
   */
  relativePath: string
}
 ...
 *
 * The emitted code has zero @cozy/runtime imports. Only hono and the
...
export function emitWorkflow(opts: EmitWorkflowOptions): EmitWorkflowResult {
  ...
  lines.push(`import config from "${upPrefix}cozy.config.js"`)
  for (const uses of sortedUses) {
